...
Before you can use the script you will need to install the python library [isoparser](https://github.com/barneygale/isoparser "title" target="_blank") by Barney Gale.
